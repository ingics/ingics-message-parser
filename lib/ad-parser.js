    ...
    while (i < length) {
        ...
        case 0x07:
            ...
            for (let j = 0; j < adData.length; j += 16) {
                this.serviceUuids.push(helper.buffToUuid(adData.slice(j, j+16).reverse()))
            }
            break
        case 0x08:
        case 0x09:
        ...
        case 0x1F:
            ...
            break
        case 0x15:
            this.serviceSolicitationUuids.push(helper.buffToUuid(adData.reverse()))
            break
        case 0x19:
        ...
        case 0x21:
            this.serviceData.push({
                uuid: helper.buffToUuid(adData.slice(0, 16).reverse()),
