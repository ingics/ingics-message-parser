...
const ibsFeatureMap = new Map([
    ...
    [ 0x42, { name: 'iBS09R', fields: [fieldDummy, fieldRange, fieldUser], events: ['button'] }], // deprecated
    [ 0x43, { name: 'iBS09PS', fields: [fieldValue, fieldCounter, fieldUser], events: [ 'detect' ] }], // deprecate
    [ 0x44, { name: 'iBS09PIR', fields: [fieldDummy, fieldDummy, fieldUser], events: ['pir'] }], //deprecated
    [ 0x45, { name: 'iBS09LX', fields: [fieldDummy, fieldLux, fieldUser], events: ['button'] }], // deprecated
    [ 0x48, { name: 'iBS08', fields: [fieldTempEnv, fieldTemp, fieldUser], events: [ 'detect' ] }], // deprecated
])

const ibsBC87FeatureMap = new Map([
    [ 0x39, { name: 'iWS01', fields: [fieldTemp, fieldHumidity1D, fieldDummy], events: [ 'button' ]}], // deprecated, reserved for backward compatibility
    [ 0x41, { name: 'iBS08T', fields: [fieldTemp, fieldHumidity1D, fieldDummy], events: ['button'] }],
    [ 0x42, { name: 'iBS09R', fields: [fieldDummy, fieldRange, fieldDummy], events: ['button'] }],
    [ 0x43, { name: 'iBS09PS', fields: [fieldDummy, fieldCounter, fieldDummy], events: [ 'detect' ] }],
    [ 0x44, { name: 'iBS09PIR', fields: [fieldDummy, fieldDummy, fieldDummy], events: ['pir'] }],
...
function ibsBC87 () {
    ...
    const feature = ibsBC87FeatureMap.get(subtype)
    ...
    const extraFlag = this.raw.readUInt8(21)
    this.events['boot'] = (extraFlag & 0x10) !== 0x00
}
