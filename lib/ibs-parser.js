...
function ibs () {
    ...
    this.battery = this.raw.readInt16LE(4)
...
function rs () {
    ...
    this.battery = this.raw.readUInt16LE(4)
...
function rg () {
    ...
    this.battery = (battActFlag & 0x0FFF)
