...
function fieldUser(idx) {
    this.user = this.raw.readUInt16LE(idx)
    return 2
}
...
const ibsBC88FeatureMap = new Map([
    [ 0x42, { name: 'iBS09R', fields: [fieldDummy, fieldRange, fieldDummy, fieldDummy, fieldDummy, fieldDummy, fieldUser], events: ['button', 'detect'] }],
    [ 0x44, { name: 'iBS09PIR', fields: [fieldDummy, fieldDummy, fieldDummy, fieldDummy, fieldDummy, fieldDummy, fieldUser], events: ['pir'] }],
    [ 0x45, { name: 'iBS08T', fields: [fieldTemp, fieldHumidity1D, fieldLux, fieldDummy, fieldDummy, fieldDummy, fieldUser], events: ['button'] }],
    [ 0x46, { name: 'iBS08IAQ', fields: [fieldTemp, fieldHumidity1D, fieldCo2, fieldPm2p5, fieldPm10p0, fieldVoc, fieldNox], events: ['button'] }],
    [ 0x47, { name: 'iBS09IR', fields: [fieldDummy, fieldCounter, fieldDummy, fieldDummy, fieldDummy, fieldDummy, fieldUser], events: ['button', 'ir'] }],
    [ 0x49, { name: 'iBS08TP', fields: [fieldTemp, fieldTempExt, fieldDummy, fieldDummy, fieldDummy, fieldDummy, fieldUser], events: ['button'] }],
    [ 0x4A, { name: 'iBS08AD-NTC', fields: [fieldDummy, fieldTempExt, fieldDummy, fieldDummy, fieldDummy, fieldDummy, fieldUser], events: ['button'] }],
    [ 0x4B, { name: 'iBS08P', fields: [fieldTemp, fieldTempExt, fieldDummy, fieldDummy, fieldDummy, fieldDummy, fieldUser], events: ['button'] }],
    [ 0x4D, { name: 'iBS08F', fields: [fieldDummy, fieldCounter, fieldDummy, fieldDummy, fieldDummy, fieldDummy, fieldUser], events: ['button', 'fall'] }],
    [ 0x4E, { name: 'iBS08Q', fields: [fieldDummy, fieldCounter, fieldDummy, fieldDummy, fieldDummy, fieldDummy, fieldUser], events: ['button', 'din'] }],
    [ 0x51, { name: 'iBS08AD-V', fields: [fieldDummy, fieldVoltage, fieldDummy, fieldDummy, fieldDummy, fieldDummy, fieldUser], events: ['button'] }],
    [ 0x52, { name: 'iBS08AD-D', fields: [fieldDummy, fieldCounter, fieldDummy, fieldDummy, fieldDummy, fieldDummy, fieldUser], events: ['button', 'din'] }],
    [ 0x53, { name: 'iBS08AD-A', fields: [fieldDummy, fieldCurrent, fieldDummy, fieldDummy, fieldDummy, fieldDummy, fieldUser], events: ['button'] }],
    [ 0x54, { name: 'iBS09', fields: [fieldDummy, fieldDummy, fieldDummy, fieldDummy, fieldDummy, fieldDummy, fieldUser], events: ['button'] }],
])
