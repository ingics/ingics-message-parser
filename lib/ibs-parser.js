...
const ibsFeatureMap = new Map([
    ...
    [ 0x02, { name: 'iBS02IR2', temp: false, humidity: false, events: [ bitIR ], counter: true } ],
    [ 0x04, { name: 'iBS02M2', temp: false, humidity: false, events: [ bitDin ] , counter: true } ],
...
function ibs (featureMap) {
    ...
    if (feature) {
        ...
        if (feature.counter) {
            if (this.raw[9] != 0xFF && this.raw[10] != 0xFF) {
                this.counter = this.raw.readUInt16LE(9)
            }
        }
        if (feature.tof) {
...
exports.supportSensorList = function () {
    return [ 'battery', 'temperature', 'temperatureExt', 'humidity', 'range', 'gp', 'counter' ]
}
