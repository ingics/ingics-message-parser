...
const ibs01FeatureMap = new Map([
    ...
    [ 0x05, { name: 'iBS01T', temp: 'temp', humidity: 'humidity', events: [ bitButton ] } ],
    [ 0x06, { name: 'iBS01G', temp: false, humidity: false, events: [ bitButton, bitMoving, bitFall ] } ],
    [ 0x07, { name: 'iBS01T', temp: 'temp', humidity: false, events: [ bitButton ] } ]
])
...
const ibsFeatureMap = new Map([
    ...
    [ 0x14, { name: 'iBS03T', temp: 'temp', humidity: 'humidity', events: [ bitButton ] } ],
    [ 0x15, { name: 'iBS03T', temp: 'temp', humidity: false, events: [ bitButton ] } ],
    ...
    [ 0x1B, { name: 'iBS03F', temp: false, humidity: 'counter', events: [ bitDin ] } ],
    [ 0x20, { name: 'iRS02', temp: 'temp', humidity: false, events: [ bitHall ] } ],
    [ 0x21, { name: 'iRS02TP', temp: 'temp', humidity: 'tempExt', events: [ bitHall ] } ],
    ...
    [ 0x32, { name: 'iBS05T', temp: 'temp', humidity: false, events: [ bitButton ] } ],
    ...
    [ 0x39, { name: 'iWS01', temp: 'temp', humidity: 'humidity1D', events: [ bitButton ]}],
    [ 0x40, { name: 'iBS06', temp: false, humidity: false, events: [] }],
    [ 0x48, { name: 'iBS08', temp: 'tempEnv', humidity: 'temp', events: [ bitIR ] }],
])
