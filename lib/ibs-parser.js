...
const ibsFeatureMap = new Map([
    ...
    [ 0x13, { name: 'iBS03R', temp: false, humidity: 'tof', events: [], tof: true } ],
    ...
    [ 0x34, { name: 'iBS05CO2', temp: false, humidity: 'co2', events: [ bitButton, bitMoving ]} ],
...
exports.supportSensorList = function () {
    return [ 'battery', 'temperature', 'temperatureExt', 'humidity', 'range', 'gp', 'counter', 'co2' ]
}
