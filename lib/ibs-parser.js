...
const ibs01FeatureMap = new Map([
    [ 0x03, { name: 'iBS01', fields: [fieldDummy, fieldDummy], events: [ 'button' ] } ],
    [ 0x04, { name: 'iBS01H', fields: [fieldDummy, fieldDummy], events: [ 'button', 'hall' ] } ],
    [ 0x05, { name: 'iBS01T', fields: [fieldTemp, fieldHumidity], events: [ 'button' ] } ],
    [ 0x06, { name: 'iBS01G', fields: [fieldDummy, fieldDummy], events: [ 'button', 'moving', 'fall' ] } ],
    [ 0x07, { name: 'iBS01T', fields: [fieldTemp, fieldDummy], events: [ 'button' ] } ]
])
...
const ibsFeatureMap = new Map([
    ...
    [ 0x12, { name: 'iBS03P', fields: [fieldTemp, fieldTempExt], events: [] }],
    ...
    [ 0x1C, { name: 'iBS03Q', fields: [fieldDummy, fieldCounter], events: [ 'din'] } ],
    [ 0x1D, { name: 'iBS03QY', fields: [fieldDummy, fieldCounter], events: [ 'din', 'din2' ] } ],
    ...
    [ 0x23, { name: 'iBS03NT', fields: [fieldDummy, fieldTempExt], events: [] } ],
    ...
    [ 0x39, { name: 'iWS01', fields: [fieldTemp, fieldHumidity1D], events: [ 'button' ]}], // deprecated, reserved for backward compatibility
    [ 0x40, { name: 'iBS06', fields: [fieldDummy, fieldDummy], events: [] }],
    [ 0x48, { name: 'iBS08', fields: [fieldTempEnv, fieldTemp], events: [ 'detect' ] }],
])
