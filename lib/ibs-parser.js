...
function fieldVoltage(idx) {
    this.voltage = this.raw.readInt16LE(idx)
    return 2
}
...
const ibsFeatureMap = new Map([
    ...
    [ 0x23, { name: 'iBS03AD-NT', fields: [fieldDummy, fieldTempExt, fieldUser], events: [] } ],
    [ 0x24, { name: 'iBS03AD-DC', fields: [fieldDummy, fieldVoltage, fieldUser], events: [] } ],
    [ 0x25, { name: 'iBS03AD-DI', fields: [fieldDummy, fieldCounter, fieldUser], events: [ 'din' ] } ],
    ...
    [ 0x42, { name: 'iBS08R', fields: [fieldDummy, fieldRange, fieldUser], events: [] }], // plan
    [ 0x43, { name: 'iBS08PS', fields: [fieldTempEnv, fieldTemp, fieldUser], events: [ 'detect' ] }], // plan
    [ 0x44, { name: 'iBS08PIR', fields: [fieldDummy, fieldDummy, fieldUser], events: ['pir'] }], //plan
