...
const ibsFeatureMap = new Map([
    ...
    [ 0x41, { name: 'iBS08T', fields: [fieldTemp, fieldHumidity1D, fieldUser], events: ['button'] }], // deprecated
    [ 0x42, { name: 'iBS09R', fields: [fieldDummy, fieldRange, fieldUser], events: ['button'] }], // deprecated, use BC88 instead
    [ 0x43, { name: 'iBS09PS', fields: [fieldValue, fieldCounter, fieldUser], events: [ 'detect' ] }], // deprecate, use BC88 instead
    [ 0x44, { name: 'iBS09PIR', fields: [fieldDummy, fieldDummy, fieldUser], events: ['pir'] }], //deprecated, use BC88 instead
    [ 0x45, { name: 'iBS09LX', fields: [fieldDummy, fieldLux, fieldUser], events: ['button'] }], // deprecated, use BC88 instead
    [ 0x48, { name: 'iBS08', fields: [fieldTempEnv, fieldTemp, fieldUser], events: [ 'detect' ] }], // deprecated, use BC88 instead
])

// long term payload for iBS07 only
const ibsBC87FeatureMap = new Map([
    [ 0x39, { name: 'iWS01', fields: [fieldTemp, fieldHumidity1D, fieldDummy], events: [ 'button' ]}], // deprecated, project canceled
    [ 0x41, { name: 'iBS08T', fields: [fieldTemp, fieldHumidity1D, fieldDummy], events: ['button'] }], // deprecated, use BC88 instead
    [ 0x42, { name: 'iBS09R', fields: [fieldDummy, fieldRange, fieldDummy], events: ['button'] }], // deprecated, use BC88 instead
    [ 0x43, { name: 'iBS09PS', fields: [fieldDummy, fieldCounter, fieldDummy], events: [ 'detect' ] }], // deprecated, use BC88 instead
    [ 0x44, { name: 'iBS09PIR', fields: [fieldDummy, fieldDummy, fieldDummy], events: ['pir'] }], // deprecated, use BC88 instead
    [ 0x45, { name: 'iBS08TL', fields: [fieldTemp, fieldHumidity1D, fieldLux], events: ['button'] }], // deprecated, use BC88 instead
...
const ibsBC88FeatureMap = new Map([
    [ 0x41, { name: 'iBS08T', fields: [fieldTemp, fieldHumidity1D, fieldDummy, fieldDummy], events: ['button'] }],
    [ 0x42, { name: 'iBS09R', fields: [fieldDummy, fieldRange, fieldDummy, fieldDummy], events: ['button'] }],
    [ 0x43, { name: 'iBS09PS', fields: [fieldDummy, fieldCounter, fieldDummy, fieldDummy], events: [ 'detect' ] }],
    [ 0x44, { name: 'iBS09PIR', fields: [fieldDummy, fieldDummy, fieldDummy, fieldDummy], events: ['pir'] }],
    [ 0x45, { name: 'iBS08TL', fields: [fieldTemp, fieldHumidity1D, fieldLux, fieldDummy], events: ['button'] }],
...
function ibsLongPayload (subtypeIdx, featureMap) {
    ...
    const extraFlag = this.raw.readUInt8(subtypeIdx + 2)
    this.events['boot'] = (extraFlag & 0x10) !== 0x00
}
